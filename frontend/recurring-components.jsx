        ...
        <div className="modal rec-modal">
          ...
          {(tab === 'details' || !editing) && (
            <div className="modal-body">
              ...
              {/* Row 3: Payer + Paying For */}
              <div className="form-grid">
                <div className="form-field">
                  <span className="field-label">Payer</span>
                  <StyledSelect id="rec-modal-payer-select" className="field-input" value={f.payer} onChange={e => set('payer', e.target.value)}>
                    {PAYERS.map(p => <option key={p} value={p}>{p}</option>)}
                  </StyledSelect>
                </div>
                <div className="form-field">
                  <span className="field-label">Paying For</span>
                  <StyledSelect id="rec-modal-payingfor-select" className="field-input" value={f.payingFor} onChange={e => set('payingFor', e.target.value)}>
              ...
              {/* Row 4: Frequency + Payment Day */}
              <div className="form-grid">
                <div className="form-field">
                  <span className="field-label">Frequency</span>
                  <StyledSelect id="rec-modal-frequency-select" className="field-input" value={f.frequency} onChange={e => set('frequency', e.target.value)}>
                ...
                {f.frequency === 'monthly' && (
                  <div className="form-field">
                    ...
                    <StyledSelect id="rec-modal-paymentday-select" className="field-input" value={f.paymentDay} onChange={e => set('paymentDay', e.target.value)}>
                      {dayOptions.map(d => (
